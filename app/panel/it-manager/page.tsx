...
export default function ITManagerPage() {
  ...
  useEffect(() => {
    ...
    import('@/lib/firebase').then(({ listenToSupportRequests }) => {
      unsub = listenToSupportRequests((requests) => {
      ...
      {view === 'tiles' && (
        <div className="flex flex-wrap justify-center gap-10">
          ...
          <Tile
            ...
            color="bg-gradient-to-br from-[oklch(0.5_0.15_220)] to-[oklch(0.35_0.12_220)]"
            onClick={() => router.push('/panel/it-manager/inventario')}
          />
        </div>
      )}
