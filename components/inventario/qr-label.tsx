  ...
  const handlePrint = () => {
    ...
    const html = `<!DOCTYPE html><html><head>
      ...
      <style>
        ...
        body { font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; margin: 0; padding: 0; width: 58mm; height: 32mm; overflow: hidden; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .label { width: 58mm; height: 32mm; box-sizing: border-box; border: 1.2px solid #1a365d; display: flex; flex-direction: column; background: #fff; }
        .header { background: linear-gradient(135deg, #1a365d, #2b6cb0); color: #fff; padding: 1.5px 5px; display: flex; justify-content: space-between; align-items: center; font-size: 6.5px; letter-spacing: 0.6px; }
        .header .title { font-weight: 700; text-transform: uppercase; }
        .header .badge { background: rgba(255,255,255,0.2); padding: 0 4px; border-radius: 2px; font-size: 5.5px; font-weight: 600; }
        .body { flex: 1; display: flex; min-height: 0; }
        .info { flex: 1; padding: 2px 5px 1px; display: flex; flex-direction: column; gap: 0; justify-content: flex-start; }
        .section-label { font-size: 5px; font-weight: 700; color: #2b6cb0; text-transform: uppercase; letter-spacing: 0.4px; line-height: 1.3; }
        .row { display: flex; font-size: 5.5px; line-height: 1.3; }
        .row .lbl { color: #718096; min-width: 24px; font-weight: 500; }
        .row .val { color: #1a202c; font-weight: 600; }
        .qr-side { width: 32px; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 1px 4px 1px 2px; border-left: 1px solid #e2e8f0; }
        .qr-side img { width: 26px; height: 26px; display: block; }
        .qr-side .hint { font-size: 3.5px; color: #a0aec0; line-height: 1; }
        .footer { border-top: 1px solid #e2e8f0; padding: 1px 5px; font-size: 4.5px; color: #a0aec0; display: flex; justify-content: space-between; }
